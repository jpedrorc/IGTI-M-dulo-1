...
function numberToText(number) {
  ...
  if (size === 1) {
    return sizeOneDescription(number, withoutZero);
  }
  var withoutZero = true;

  if (size === 2) {
    return sizeTwoDescription(number, withoutZero);
  }
  if (size === 3) {
    return sizeThreeDescription(number, withoutZero);
  }
  return size;
}
function sizeOneDescription(number, withoutZero) {
  if (number === '0' && !withoutZero) return 'zero';
  if (number === '0' && withoutZero) return '';
...
function sizeTwoDescription(number, withoutZero) {
  ...
  return prefix + sizeOneDescription(secondCharacter, withoutZero);
}
function sizeThreeDescription(number, withoutZero) {
  ...
  var secondNThirdCharacter = number.substring(1);
  var prefix = null;
  ...
  if (secondCharacter === '0') {
    return prefix + sizeOneDescription(thirdCharacter, withoutZero);
  }

  return prefix + sizeTwoDescription(secondNThirdCharacter, withoutZero);
}
